...
mykmeans <- function(Data, k=5, threshold=1){
  ...
  write(result, file = "/Users/hchen/Desktop/DK/Machine\ Learning/Lab2/TP-R-package/read-write-files-in-C-language/output.txt",sep = "\n")
}

mykmeans(Data,k=15,threshold=1)
