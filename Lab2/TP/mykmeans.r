...
Data <- read.table("/Users/hchen/Desktop/DK/Machine\ Learning/Lab2/TP/hello_input.txt")
...
mykmeans <- function(Data, k=5, threshold=1){
  ...
  write(result, file = "/Users/hchen/Desktop/DK/Machine\ Learning/Lab2/TP/hello_output25.txt",sep = "\n")
}
